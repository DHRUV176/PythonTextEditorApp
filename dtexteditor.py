...
main_application.title('DNP TEXT EDITOR')
...
## color theme 
def change_theme():
    chosen_theme = theam_choice.get()
    color_tuple = color_dict.get(chosen_theme)
    fg_color, bg_color = color_tuple[0], color_tuple[1]
    text_editor.config(background=bg_color, fg=fg_color) 
count = 0 
for i in color_dict:
    color_theam.add_radiobutton(label = i, image=color_icons[count], variable=theam_choice, compound=tk.LEFT, command=change_theme)
    count += 1 
